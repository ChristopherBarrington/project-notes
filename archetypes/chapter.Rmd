...
```{r write_slugs}
#| child=system.file('chunks/write_slugs.Rmd', package='project.notes.tools'),
#| slugs=list()
```
...
#| bibliography_doi=c(),
#| child=system.file('chunks/write_bibliography.Rmd', package='project.notes.tools')
```

<!-- include a session information section -->
```{r show_session_information}
#| child=system.file('chunks/session_information.Rmd', package='project.notes.tools'),
#| opts.label='batch_chunk',
#| saved_objects <- c()
```
