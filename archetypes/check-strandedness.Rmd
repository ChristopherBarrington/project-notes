...
```{bash setup_wd, opts.label='batch_chunk', code=readLines(system.file('chunks/working_directory.sh', package='project.notes.tools')), echo=FALSE}
```

<!-- read the standard knitr setup script -->
```{r knitr_setup, opts.label='batch_chunk', code=readLines(system.file('chunks/knitr.r', package='project.notes.tools')), echo=FALSE}
```
...
c(RSeQC='10.1093/bioinformatics/bts356',
  STAR='10.1093/bioinformatics/bts635') -> bibliography_doi
```
