...
c(clustree='10.1093/gigascience/giy083') -> bibliography_doi
```
...
```{r get_clustree_plots_for_qc_filtered, dependson='function_to_get_clustree_plots', echo=TRUE}
...
```{r show_clustree_plots_for_qc_filtered, dependson='get_clustree_plots_for_qc_filtered', echo=FALSE, cache=FALSE, results='asis'}
...
```{r get_clustree_plots_for_qc_filtered_subsets, dependson='function_to_get_clustree_plots', echo=TRUE}
data(project_sample_sheet)
...
```{r show_clustree_plots_for_qc_filtered_subsets, dependson='get_clustree_plots_for_qc_filtered_subsets', echo=FALSE, results='asis'}
plots_list %>%
