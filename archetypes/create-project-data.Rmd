...
```{r write_bibliography, dependson='add_doi_to_bibliography', eval={length(bibliography_doi)}>0, cache=TRUE, echo=FALSE, code=readLines(system.file('chunks/write_bibliography.r', package='project.notes.tools'))}
```
