...
cat('{{< tabs "show_feature_count_plots" >}}', sep='\n')
...
```{r show_dispersion_plots_for_each_comparison}
...
for(i in names(plots_list)) {
  sprintf('{{< tab "%s" >}}', i) %>% cat(sep='\n')
  {pluck(plot_list, i, 'density') + pluck(plots_list, i, 'boxplot') + plot_layout(widths=unit(3,'in'), height=unit(3/1.6, 'in'))} %>% show()
  cat('{{< /tab >}}', sep='\n')
}
...
#| bibliography_doi=c(deseq2='10.1186/s13059-014-0550-8',
